...
def main() -> None:
    ...
    news = """President Donald Trump on Wednesday called on a top policymaker at the Federal Reserve to resign, after one of his allies alleged that she committed mortgage fraud.
...
“I learned from the media that FHFA Director William Pulte posted on social media that he was making a criminal referral based on a mortgage application from four years ago, before I joined the Federal Reserve,” Cook wrote in a statement.
...
“She needs to explain herself, but it’s all there in black and white,” Pulte said in a phone interview with CNBC on Wednesday. “I think she needs to resign quickly.”
...
The housing official has functioned as a reliable attack dog for the Trump administration, routinely taking to social media to berate Powell, essentially around the clock. Sen. Elizabeth Warren of Massachusetts has criticized Pulte’s incessant use of social media for political attacks.

But Pulte told CNBC that his call for Cook to resign was apolitical.
...
Related article
Stephen Miran testifies during a Senate hearing in Washington, DC, on February 27.
...
Cook is the first Black woman appointed to the Fed’s Board of Governors.
...
Since Trump began his second term, Powell has resisted the president’s demands to lower rates and has mostly refrained from responding to his personal attacks. Trump recently backed off from his threats to fire Powell, though it would have led to an uphill battle in the courts if he were to try.

“It looks to me like the administration is admitting they can’t push Powell out or push him around,” said Joe Brusuelas, chief economist at RSM US. “Moreover, they realize that even when they appoint his successor, there is no guarantee they achieve their preferred policy outcome.”

“They are going to need to create the conditions where they can replace enough members to get the votes they want,” he added."""
